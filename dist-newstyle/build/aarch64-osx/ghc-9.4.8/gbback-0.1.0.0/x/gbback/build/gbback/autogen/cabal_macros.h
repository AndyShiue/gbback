...
/* package gbback-0.1.0.0 */
#ifndef VERSION_gbback
#define VERSION_gbback "0.1.0.0"
#endif /* VERSION_gbback */
#ifndef MIN_VERSION_gbback
#define MIN_VERSION_gbback(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_gbback */
...
#define CURRENT_COMPONENT_ID "gbback-0.1.0.0-inplace-gbback"
